  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        actions={<form className="flex w-full max-w-md gap-2"><label className="flex min-h-11 flex-1 items-center gap-2 rounded-xl border border-[var(--line)] bg-white px-3 focus-within:border-[var(--shop-primary)] focus-within:ring-4 focus-within:ring-[color-mix(in_srgb,var(--shop-primary),white_78%)]"><Search size={16} className="shrink-0 text-slate-400" /><input className="min-w-0 flex-1 bg-transparent outline-none" name="q" defaultValue={query} placeholder="Name, phone, email or group" aria-label="Search customers" /></label><Button variant="outline">Search</Button></form>}
      />
