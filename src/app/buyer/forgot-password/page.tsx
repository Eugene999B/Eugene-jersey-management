  ...
  return (
    <main className="min-h-screen bg-[#07111f] px-4 py-8 text-white sm:px-6">
      <section className="mx-auto max-w-xl">
        <Link href="/" className="inline-flex items-center gap-3"><Image src="/brand/esm-mark.svg" alt="Eugene Shop Management" width={44} height={44} priority /><div><p className="text-sm font-bold">Eugene Shop Management</p><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-white/40">Buyer password recovery</p></div></Link>
