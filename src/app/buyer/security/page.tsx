        ...
        <header className="mb-6 rounded-3xl bg-[#07111f] p-5 text-white shadow-xl sm:p-7">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-3">
              ...
              <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-cyan-300">{buyer.name}</p><h1 className="mt-1 text-3xl font-semibold tracking-[-0.03em]">Buyer account security</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">Two-factor authentication is optional and controlled only by you. It protects ordering, messaging, pickup, delivery and account activity after your password.</p></div>
            </div>
