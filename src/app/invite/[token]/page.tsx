  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6f4ef] p-5">
      <div className="panel w-full max-w-md p-6">
        <div className="mb-5 flex items-center gap-3"><Image src={invite.shop.logoUrl || "/brand/esm-mark.svg"} alt={invite.shop.name} width={48} height={48} className="rounded-[8px]" /><div><p className="text-xs font-semibold uppercase text-[#0f766e]">Secure staff invitation</p><p className="font-semibold">Eugene Shop Management</p></div></div>
