        ...
        <div className="flex min-h-screen items-center bg-[#f4f2ec] px-4 py-8 text-slate-950 sm:px-8 lg:px-12 xl:px-20">
          <div className="mx-auto w-full max-w-xl">
            ...
            <form action="/api/auth/login" method="post" className="rounded-2xl border border-[#d9d3c8] bg-white p-5 shadow-[0_24px_70px_rgba(15,23,42,0.09)] sm:p-7">
              ...
              <label className="block"><span className="mb-2 block text-sm font-semibold">Login ID or work email</span><input className="field min-h-12" name="loginId" autoComplete="username" defaultValue={params.loginId ?? ""} placeholder="Your personal Login ID" required autoFocus /></label>
              ...
              <button className="mt-6 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#0f766e] px-5 text-sm font-semibold text-white transition hover:bg-[#0b5f59] focus:outline-none focus:ring-4 focus:ring-emerald-200">Open workspace <ArrowRight size={17} /></button>
