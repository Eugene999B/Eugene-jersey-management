  ...
  return (
    <ApplicationShell>
      ...
      <section className="mx-auto mt-10 grid max-w-4xl gap-5 md:grid-cols-2">
        <Link href="/apply/shop" className="group rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-950/5 transition hover:-translate-y-1 hover:border-cyan-300"><span className="inline-flex rounded-2xl bg-cyan-50 p-3 text-cyan-700"><Store size={24} /></span><h2 className="mt-6 text-2xl font-bold">Shop application</h2><p className="mt-3 text-sm leading-7 text-slate-600">For sports shops, jersey businesses, printers and equipment retailers that need their own secure workspace and marketplace profile.</p><span className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-cyan-700">Start shop application <ArrowRight size={16} /></span></Link>
