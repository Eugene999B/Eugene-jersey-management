...
describe("product size variants", () => {
  ...
  it("uses one catalog product with a JSON option matrix and variant-specific POS rows", () => {
    ...
    expect(catalog).toContain("Only the item name and base price are essential");
