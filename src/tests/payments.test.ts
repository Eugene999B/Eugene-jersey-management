...
import { amountToSubunit, isPaystackCheckoutReady, verifyPaystackWebhookSignature } from "@/lib/payments";
...
describe("Paystack helpers", () => {
  ...
  it("requires secret key, card allowance, and subaccount before checkout is ready", () => {
