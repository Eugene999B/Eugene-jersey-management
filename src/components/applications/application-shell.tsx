    ...
    <main className="min-h-screen bg-[#f4f7fb] text-[#07111f]">
      <header className="border-b border-slate-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-4 sm:px-6">
          <Link href="/" className="flex min-w-0 items-center gap-3"><Image src="/brand/esm-mark.svg" alt="Eugene Shop Management" width={42} height={42} priority /><div className="min-w-0"><p className="truncate text-sm font-extrabold sm:text-base">Eugene Shop Management</p><p className="hidden text-[10px] font-bold uppercase tracking-[0.16em] text-slate-400 sm:block">Business applications</p></div></Link>
